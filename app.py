...
from flask import (
    ...
    make_response, flash, session, abort
)

app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "dev-secret")

# Cookies/sessions un peu plus propres
app.config["SESSION_COOKIE_SAMESITE"] = "Lax"

# Durée session “joueur”
app.permanent_session_lifetime = timedelta(days=365)

# 🔐 Clé admin (à définir sur Render > Environment)
ADMIN_KEY = os.environ.get("ADMIN_KEY", "")
ADMIN_SESSION_DAYS = 7

# (Optionnel mais recommandé si tu mets un disque persistant Render)
# Sur Render tu peux définir DATA_DIR=/var/data
